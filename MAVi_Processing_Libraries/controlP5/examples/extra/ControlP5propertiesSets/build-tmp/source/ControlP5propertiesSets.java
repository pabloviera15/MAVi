...
public class ControlP5propertiesSets extends PApplet {
...
*/
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ControlP5propertiesSets" };
    if (passedArgs != null) {
